...
const CONTRACT_ADDRESS = "0xd620B56bFbd43e489656A63C9f9cC1A3dC3d3EF6";
...
const ABI = [
    ...
    // Market struct (10-field, as deployed)
    "function markets(uint256 id) view returns (uint256 id, string description, bool resolved, uint8 winningOutcome, uint256 totalPool0, uint256 totalPool1, uint256 creationTimestamp, bool resolutionProposed, uint8 proposedOutcome, uint256 challengeWindowEndTime)",
